...
def build_investigation(req: InvestigateRequest) -> str:
    ...
    lines.append("")
    lines.append("---")
    lines.append(f"*Investigation generated by RiskSense AI Engine v2.0 | Bayesian mode: {'active' if req.total_observations > 0 else 'prior-only'} | Mode: {req.mode.upper()}*")
